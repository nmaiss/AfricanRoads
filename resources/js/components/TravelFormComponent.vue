                ...
                <b-card-text>
                    ...
                    <b-container class="bv-example-row bv-example-row-flex-cols infos-form">
                        ...
                        <b-row>
                            ...
                            <b-col>
                                <div class="yes-form" @click="can_transport()">
                                    Oui
                                </div>
                                <img src="/images/check.png" class="transport-check-form-yes" v-if="transport === true">
                    ...
                    <b-container fluid class="text-light text-center">
                        <b-row>
                            ...
                            <b-col cols="auto" class="p-3">
                                <div class="next-step" v-if="validate() && transport === true" @click="next()">
                                    <img src="/images/Flèche verte.jpg">
                                </div>
                                <div class="next-step" v-if="validate() && transport === false" @click="submit()">
...
<script>
    export default {
        ...
        methods: {
            ...
            validate() {
                if ((this.from === "" || this.to === "" || this.date === "") && this.max_step === 0) {
                    return 0;
                }
